...
export EDX_VARS="-e EDXAPP_LMS_SITE_NAME=$EDX_DOMAIN -e EDXAPP_CMS_SITE_NAME=studio.$EDX_DOMAIN -e edx_platform_version=$EDX_PLATFORM_VERSION"
...
echo instance_type=\"$AWS_EC2_INSTANCE\" >> terraform/packer.auto.tfvars